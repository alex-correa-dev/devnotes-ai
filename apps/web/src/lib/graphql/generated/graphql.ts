...
export type SearchNotesWithFacetsQuery = { searchNotesWithFacets: { total: number, facets: { tags: Array<{ value: string, count: number }> }, notes: Array<{ id: string, title: string, content: string, tags: Array<string>, createdAt: unknown }> } };
